...
<form action="" method="post">
  ...
  <div class="form-group">
    ...
    <input type="password" name="password" class="form-control col-md-3" id="exampleInputPassword1" placeholder="Enter Password">
  </div>
...
<div class="container text-center">
    <h4>I am a Demo purpose website. Design is not my concern.</h4>
</div>
